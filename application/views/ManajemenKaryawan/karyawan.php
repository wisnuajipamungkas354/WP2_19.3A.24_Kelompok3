    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <?php if (empty($data_karyawan)) : ?>
                <div class="alert alert-warning" role="alert"><i class="fas fa-exclamation-circle"></i><span> Data Karyawan tidak ditemukan!</span></div>
            <?php endif; ?>

            <!-- Table -->
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <a href="<?= base_url('ManajemenKaryawan/karyawan_tambah'); ?>" title="Tambah Data" class="btn btn-success font-weight-bold"><i class="fas fa-fw fa-plus"></i> Tambah</a>
                                ...
                                <?php foreach ($data_karyawan as $karyawan) : ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <a href="<?= base_url('ManajemenKaryawan/karyawan_ubah/'); ?><?= $karyawan['id_karyawan']; ?>" title="Ubah" class="btn btn-circle btn-warning my-1"><i class="fas fa-fw fa-edit"></i></a>
                                            <a href="<?= base_url('ManajemenKaryawan/karyawan_hapus/'); ?><?= $karyawan['id_karyawan']; ?>" title="Hapus" class="btn btn-danger btn-circle delete-pegawai"><i class="fas fa-fw fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
