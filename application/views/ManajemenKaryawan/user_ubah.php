                ...
                <div class="card mb-4">
                    <div class="card-body text-dark font-weight-bold">
                        <div class="form-group">
                            ...
                            <div class="col-sm">
                                <input type="text" class="form-control" id="id_karyawan" name="id_karyawan" value="<?= $ubah_user['id_karyawan']; ?>" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm">
                                <input type="text" class="form-control" id="nm_karyawan" name="nm_karyawan" value="<?= $ubah_user['nm_karyawan']; ?>" readonly>
